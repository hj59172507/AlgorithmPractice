...
Time O(n)
Space O(1)
In a for loop, define right as the max value we see, if right = number of light bulb, then we must have all bulbs on left light up.
 */
namespace LeetCodePractice.Greedy
{
    class TimesAllBulbareBlue
    {
        //static void Main()
