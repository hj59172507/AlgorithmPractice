...
Time O(n)
Space O(1)
Use two pointer to represent each split decision.
Always choose smaller element to add first, since this will maximize score if there is common integer later.
"""
